...
const ICONS: Record<string, (p: IconProps) => React.ReactElement> = {
  ...
  "Phí Cầu đường": Car,
  "Hoá đơn điện": Bolt,
  "Hoá đơn nước": Droplet,
  "Hoá đơn điện thoại": Phone,
  "Mua đồ điện tử, đt": Monitor,
  "Phần mềm, AI": Monitor,
  "Mua đồ dùng gđ": Home,
  "Ck vợ": Users,
  "Ck mẹ": Users,
  ...
  "Tiêu vặt Nhím": Baby,
  "Tiêu vặt Bon": Baby,
  "TIT HP": GraduationCap,
  "NHÍM HP": GraduationCap,
  "BON HP": GraduationCap,
  "Tit ngoại khoá": Book,
  "Sách vở": Book,
  "Đồng phục": Shirt,
  "Khám sức khoẻ": Heart,
  ...
  "Hiếu hỉ": Gift,
  "Thăm hỏi": Gift,
  "Cho tặng từ thiện": Heart,
  "Vui - chơi": Gamepad,
  "Đầu tư coin": TrendingUp,
  "Trả lãi": Percent,
  "Phí Ck": Receipt,
  "Thuế đất": Receipt,
  "Chi hộ thẻ TD": CreditCard,
  "Ack": Wallet,
  "NN": Tag,
  "Tilo Pp": Tag,
  "RT": Refund,
  "Các chi phí khác": Tag,
  "Chưa phân loại": Folder,
  "ĐIỀU CHỈNH SỐ DƯ": TrendingUp,
  "Cho tặng": Gift,
  "Thu coin": TrendingUp,
  "Thu lãi": Percent,
  "Thu nợ": MoneyBag,
  "Tiền hoàn Bank": Refund,
  "Thanh lý": Tag,
  "RT thẻ": CreditCard,
};
